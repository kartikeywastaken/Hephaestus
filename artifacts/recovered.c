 ...
 * Generated: 2026-06-16T17:43:52Z
 *
...
uint64_t cfg_pressure(uint64_t arg1, int32_t arg2, uint64_t arg_50h);
uint64_t indirect_pressure(uint64_t arg1, int32_t arg_40h);
uint64_t stack_layout_pressure(uint64_t arg1);
uint64_t abi_pressure(uint64_t arg1, int32_t arg2, uint64_t arg3, int32_t arg4, uint64_t arg5, int32_t arg6, uint64_t arg7, int32_t arg8, uint64_t arg_60h);
uint64_t rotmix(uint64_t arg1, int32_t arg_10h);
uint64_t op_add(uint64_t arg1, int32_t arg2, uint64_t arg_20h);
uint64_t op_xor(uint64_t arg1, int32_t arg2, uint64_t arg_20h);
uint64_t op_mul(uint64_t arg1, int32_t arg2, uint64_t arg_20h);
uint64_t op_shift(uint64_t arg1, int32_t arg2, uint64_t arg_20h);
uint64_t op_div(uint64_t arg1, int32_t arg2, uint64_t arg_20h);
uint64_t op_logic(uint64_t arg1, int32_t arg2, uint64_t arg_20h);
uint64_t tri_a(uint64_t arg1, uint64_t arg2, int32_t arg3, int32_t arg_40h);
uint64_t tri_b(uint64_t arg1, uint64_t arg2, int32_t arg3, int32_t arg_30h);
uint64_t tri_c(uint64_t arg1, uint64_t arg2, int32_t arg3, int32_t arg_40h);
...
int32_t main(int32_t argc, char ** argv)
{
    ...
    *(u64 *)(tmp_x9) = tmp_x8; /* str x8, [x9] */
    ...
    call_0x100001830(tmp_x0); /* bl sym.imp.printf; args refined from same-block evidence */
...
uint64_t indirect_pressure(uint64_t arg1, int32_t arg_40h)
{
    ...
    while (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.hs at 0x100000b6c after subs at 0x100000b68; target 0x100000ca4; loop polarity inverted")) {
        /* block 0x100000b64 */
        tmp_x8 = stack_24; /* ldr x8, [sp + var_18h] */
        tmp_x8 = tmp_x8 - 96; /* subs x8, x8, 0x60; flags updated */
        /* conditional branch b.hs -> 0x100000ca4 */
        /* block 0x100000b70 */
...
uint64_t stack_layout_pressure(uint64_t arg1)
{
    ...
    tmp_x8 = 0x100004000; /* adrp x8, reloc.printf */
    ...
    if (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.eq at 0x100001034 after subs at 0x100001030; target 0x100001040; polarity inverted")) {
        ...
        /* block 0x10000103c */
        call_0x10000183c(); /* bl sym.imp.__stack_chk_fail */
    } else {
        /* block 0x100001040 */
...
uint64_t abi_pressure(uint64_t arg1, int32_t arg2, uint64_t arg3, int32_t arg4, uint64_t arg5, int32_t arg6, uint64_t arg7, int32_t arg8, uint64_t arg_60h)
{
    ...
    tmp_x1 = stack_32; /* ldr x1, [sp + var_20h] */
    call_0x1000012b0(tmp_x0, tmp_x1); /* bl sym._op_add; args refined from same-block evidence */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 + tmp_x0; /* add x8, x8, x0 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x0 = stack_24; /* ldr x0, [sp + var_18h] */
    tmp_x1 = stack_16; /* ldr x1, [sp + var_10h] */
    call_0x1000012f4(tmp_x0, tmp_x1); /* bl sym._op_xor; args refined from same-block evidence */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 ^ tmp_x0; /* eor x8, x8, x0 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x0 = stack_8; /* ldr x0, [sp + var_8h] */
    tmp_x1 = stack_m8; /* ldur x1, [x29, -8] */
    call_0x100001338(tmp_x0, tmp_x1); /* bl sym._op_mul; args refined from same-block evidence */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 + tmp_x0; /* add x8, x8, x0 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x0 = stack_m16; /* ldur x0, [x29, -0x10] */
    tmp_x1 = stack_8; /* ldr x1, [sp + var_8h] */
    call_0x100001384(tmp_x0, tmp_x1); /* bl sym._op_shift; args refined from same-block evidence */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 ^ tmp_x0; /* eor x8, x8, x0 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    ...
    call_0x1000013dc(tmp_x0, tmp_x1); /* bl sym._op_div; args refined from same-block evidence */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 + tmp_x0; /* add x8, x8, x0 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x0 = stack_m32; /* ldur x0, [x29, -0x20] */
    tmp_x1 = stack_40; /* ldr x1, [sp + var_28h] */
    call_0x100001444(tmp_x0, tmp_x1); /* bl sym._op_logic; args refined from same-block evidence */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 ^ tmp_x0; /* eor x8, x8, x0 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    ...
    while (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.hs at 0x100001148 after subs at 0x100001144; target 0x1000011fc; loop polarity inverted")) {
        /* if/else condition block: 0x100001140 */
        /* merge block: 0x1000011ec */
        if (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.hs at 0x100001148 after subs at 0x100001144; target 0x1000011fc")) {
            /* block 0x1000011c8 */
...
uint64_t rotmix(uint64_t arg1, int32_t arg_10h)
{
    ...
    stack_8 = tmp_x0; /* str x0, [sp + var_8h] */
    tmp_x9 = stack_8; /* ldr x9, [sp + var_8h] */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 ^ (tmp_x9 >> 0); /* eor x8, x8, x9, lsr 33 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    ...
    tmp_x9 = stack_8; /* ldr x9, [sp + var_8h] */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 ^ (tmp_x9 >> 0); /* eor x8, x8, x9, lsr 29 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    ...
    tmp_x9 = stack_8; /* ldr x9, [sp + var_8h] */
    tmp_x8 = stack_8; /* ldr x8, [sp + var_8h] */
    tmp_x8 = tmp_x8 ^ (tmp_x9 >> 0); /* eor x8, x8, x9, lsr 32 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x10 = stack_8; /* ldr x10, [sp + var_8h] */
    tmp_x9 = 0x100008000; /* adrp x9, 0x100008000 */
    tmp_x8 = *(u64 *)(tmp_x9 + 80); /* ldr x8, [x9, 0x50] */
...
uint64_t op_add(uint64_t arg1, int32_t arg2, uint64_t arg_20h)
{
    ...
    /* Layout candidates: */
    /*   base=sp, kind=array_like, offsets=[8, 16, 24], sizes=[4] */
    /*   base=x9, kind=scalar, offsets=[80], sizes=[4] */
    ...
    stack_24 = tmp_x0; /* str x0, [sp + var_18h] */
    stack_16 = tmp_x1; /* str x1, [sp + var_10h] */
    tmp_x8 = stack_24; /* ldr x8, [sp + var_18h] */
    tmp_x9 = stack_16; /* ldr x9, [sp + var_10h] */
    tmp_x8 = tmp_x8 + tmp_x9; /* add x8, x8, x9 */
...
uint64_t op_shift(uint64_t arg1, int32_t arg2, uint64_t arg_20h)
{
    ...
    tmp_x8 = stack_24; /* ldr x8, [sp + var_18h] */
    tmp_x9 = stack_16; /* ldr x9, [sp + var_10h] */
    tmp_x9 = tmp_x9 & 7; /* and x9, x9, 7 */
    tmp_x8 = tmp_x8 << tmp_x9; /* lsl x8, x8, x9 */
    tmp_x9 = stack_16; /* ldr x9, [sp + var_10h] */
    tmp_x10 = stack_24; /* ldr x10, [sp + var_18h] */
    tmp_x10 = tmp_x10 & 3; /* and x10, x10, 3 */
    tmp_x10 = tmp_x10 + 1; /* add x10, x10, 1 */
...
uint64_t op_div(uint64_t arg1, int32_t arg2, uint64_t arg_20h)
{
    ...
    stack_16 = tmp_x1; /* str x1, [sp + var_10h] */
    tmp_x8 = stack_16; /* ldr x8, [sp + var_10h] */
    tmp_x8 = tmp_x8 | 1; /* orr x8, x8, 1 */
    stack_8 = tmp_x8; /* str x8, [sp + var_8h] */
    tmp_x8 = stack_24; /* ldr x8, [sp + var_18h] */
    tmp_x9 = stack_8; /* ldr x9, [sp + var_8h] */
    tmp_x8 = tmp_x8 / tmp_x9; /* udiv x8, x8, x9 */
    tmp_x9 = stack_24; /* ldr x9, [sp + var_18h] */
    tmp_x11 = stack_8; /* ldr x11, [sp + var_8h] */
...
uint64_t op_logic(uint64_t arg1, int32_t arg2, uint64_t arg_20h)
{
    ...
    tmp_x9 = tmp_x9 ^ (tmp_x10 << 0); /* eor x9, x9, x10, lsl 2 */
...
uint64_t tri_a(uint64_t arg1, uint64_t arg2, int32_t arg3, int32_t arg_40h)
{
    /* Entry: 0x100001498 */
    /* Body status: structured */
    /* 12 basic block(s), 50 instruction(s) */
    /* WARNING: unknown_return_type_defaulted_to_u64 */

    /* Layout candidates: */
    /*   base=sp, kind=record_like, offsets=[12, 16, 24], sizes=[4] */
    ...
    stack_m8 = tmp_x0; /* stur x0, [x29, -8] */
    stack_m16 = tmp_x1; /* stur x1, [x29, -0x10] */
    stack_24 = tmp_x2; /* str x2, [sp + var_18h] */
    tmp_x8 = stack_m8; /* ldur x8, [x29, -8] */
    tmp_x9 = stack_m16; /* ldur x9, [x29, -0x10] */
    tmp_x8 = tmp_x8 ^ (tmp_x9 << 0); /* eor x8, x8, x9, lsl 1 */
    tmp_x9 = stack_24; /* ldr x9, [sp + var_18h] */
    ...
    while (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.ge at 0x1000014d8 after subs at 0x1000014d4; target 0x100001550; loop polarity inverted")) {
        ...
        if (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.ge at 0x1000014d8 after subs at 0x1000014d4; target 0x100001550")) {
            ...
            /* block 0x100001524 */
            tmp_x0 = stack_16; /* ldr x0, [sp + var_10h] */
            tmp_x1 = (i64)(i32)stack_12; /* ldrsw x1, [sp + var_ch] */
            call_0x1000012b0(tmp_x0, tmp_x1); /* bl sym._op_add; args refined from same-block evidence */
            tmp_x8 = stack_16; /* ldr x8, [sp + var_10h] */
            tmp_x8 = tmp_x8 ^ tmp_x0; /* eor x8, x8, x0 */
            stack_16 = tmp_x8; /* str x8, [sp + var_10h] */
...
uint64_t tri_b(uint64_t arg1, uint64_t arg2, int32_t arg3, int32_t arg_30h)
{
    ...
    /* Layout candidates: */
    /*   base=sp, kind=record_like, offsets=[0, 12, 16, 24, 32, 40], sizes=[4] */
    /*   base=x9, kind=scalar, offsets=[80], sizes=[4] */
    ...
    /* block 0x100001560 */
    tmp_sp = tmp_sp - 48; /* sub sp, sp, 0x30 */
    stack_40 = tmp_x0; /* str x0, [sp + var_28h] */
    stack_32 = tmp_x1; /* str x1, [sp + var_20h] */
    stack_24 = tmp_x2; /* str x2, [sp + var_18h] */
    tmp_x8 = stack_40; /* ldr x8, [sp + var_28h] */
    tmp_x9 = stack_32; /* ldr x9, [sp + var_20h] */
    tmp_x8 = tmp_x8 + tmp_x9; /* add x8, x8, x9 */
    ...
    while (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.ge at 0x100001598 after subs at 0x100001594; target 0x100001628; loop polarity inverted")) {
        ...
        if (HEPHAESTUS_UNKNOWN_COND("condition evidence: b.ge at 0x100001598 after subs at 0x100001594; target 0x100001628")) {
            ...
            /* block 0x100001600 */
            tmp_w8 = stack_16; /* ldrb w8, [sp + var_10h] */
...
uint64_t tri_c(uint64_t arg1, uint64_t arg2, int32_t arg3, int32_t arg_40h)
{
    /* Entry: 0x100001648 */
    /* Body status: unstructured */
    /* 32 basic block(s), 122 instruction(s) */
    /* WARNING: unknown_return_type_defaulted_to_u64 */

    /* Layout candidates: */
    /*   base=sp, kind=record_like, offsets=[0, 12, 16, 24], sizes=[4] */
    ...
    /* reason: irreducible_cfg */
    {
        ...
        tmp_x9 = stack_24; /* ldr x9, [sp + var_18h] */
        tmp_x8 = tmp_x8 + tmp_x9; /* add x8, x8, x9 */
        tmp_x9 = (i64)(i32)stack_12; /* ldrsw x9, [sp + var_ch] */
        tmp_x8 = tmp_x8 + tmp_x9; /* add x8, x8, x9 */
        tmp_x8 = tmp_x8 & 7; /* and x8, x8, 7 */
        stack_0 = tmp_x8; /* str x8, [sp] */
        ...
        tmp_x9 = stack_16; /* ldr x9, [sp + var_10h] */
        tmp_x8 = stack_16; /* ldr x8, [sp + var_10h] */
        tmp_x8 = tmp_x8 >> 2; /* lsr x8, x8, 2 */
        tmp_x8 = tmp_x8 ^ (tmp_x9 << 0); /* eor x8, x8, x9, lsl 5 */
        stack_16 = tmp_x8; /* str x8, [sp + var_10h] */
        /* branch to 0x10000180c */ /* b 0x10000180c */
        /* block 0x100001788 */
        tmp_x8 = stack_16; /* ldr x8, [sp + var_10h] */
