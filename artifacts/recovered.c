/*
 * recovered.c — Phase 5.3 Conservative Structured Reconstruction
 * Schema version: 5.3.0
 * Generated: 2026-06-15T19:39:07Z
 *
...
int32_t main(int32_t argc, void * argv)
{
    ...
    while (/* condition unknown: loop header 0x100000488 */) {
        /* block 0x100000488 */
    ...
    call_0x1000006b4(tmp_x0, tmp_x1); /* bl 0x1000006b4 */
    /* block 0x100000514 */
    ...
    *(u64 *)(tmp_x9 + 16) = tmp_x8; /* str x8,[x9, #0x10] */
    ...
    call_0x10000084c(tmp_x0); /* bl 0x10000084c */
    /* block 0x100000548 */
    tmp_w8 = stack_44; /* ldr w8,[sp, #0x2c] */
    ...
    /* block 0x100000570 */
    call_0x100000840(); /* bl 0x100000840 */
...
uint64_t reduce_weird(uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg_40h)
{
    ...
    while (/* condition unknown: loop header 0x1000005a8 */) {
        /* if/else condition block: 0x1000005a8 */
        /* merge block: 0x100000610 */
        if (/* condition unknown: block 0x1000005a8 */) {
            /* block 0x1000005d4 */
            ...
            call_0x1000007a8(tmp_x0, tmp_x1); /* bl 0x1000007a8 */
            /* block 0x100000600 */
        ...
        if (/* condition unknown: block 0x100000628 */) {
            /* block 0x100000638 */
...
uint64_t nested_control(int32_t arg1, int32_t arg_20h)
{
    ...
    while (/* condition unknown: loop header 0x1000006cc */) {
        /* block 0x1000006cc */
        tmp_w8 = stack_20; /* ldr w8,[sp, #0x14] */
        ...
        while (/* condition unknown: loop header 0x1000006e4 */) {
            /* if/else condition block: 0x1000006e4 */
            /* merge block: 0x100000740 */
            if (/* condition unknown: block 0x1000006e4 */) {
                /* block 0x100000714 */
        ...
        if (/* condition unknown: block 0x100000754 */) {
            /* block 0x100000764 */
...
uint64_t mix_value(uint64_t arg1, uint64_t arg_10h)
{
    ...
    while (/* condition unknown: loop header 0x1000007c0 */) {
        /* if/else condition block: 0x1000007c0 */
        /* merge block: 0x100000820 */
        if (/* condition unknown: block 0x1000007c0 */) {
            /* block 0x1000007f8 */
